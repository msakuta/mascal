...
export async function activate(context: ExtensionContext) {
  ...
  const traceOutputChannel = window.createOutputChannel("Mascal Language Server trace");
  ...
  client = new LanguageClient("mascal-lsp-server", "mascal language server", serverOptions, clientOptions);
