...
pub use self::func::{NativeFn, NativeFnRef, UserData};
pub use self::interpreter::{run, EvalContext, FuncDef, NativeCode, RunResult};
...
pub use self::type_infer::{type_check, TypeCheckContext, TypeCheckError};
